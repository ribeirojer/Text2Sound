...
const TextToAudio = (props: Props) => {
  ...
  return (
<Layout>
<h1 className="text-center text-2xl md:text-4xl font-bold mb-6">Conversor de Texto para Áudio</h1>
      {!audioUrl ? (
        ...
        <div>
<AudioPlayer audioUrl={audioUrl} audioRef={audioRef} wordTimings={wordTimings} currentWordIndex={currentWordIndex} resetCurrentWordIndex={resetCurrentWordIndex}/>
        <button
